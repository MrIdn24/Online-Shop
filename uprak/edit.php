...
if (isset($_POST["simpan"])) {
    ...
    $querry = mysqli_query($conn, "UPDATE produk SET nama_produk='$nama_produk', kategori='$kategori', stok='$stock', gambar='$gambar', detail='$detail' WHERE id='$id'");
            ...
            <div class="row justify-content-center text-dark">
                ...
                <div class="col-md-5 p-4">
                    ...
                    <div class="form-floating">
                        <textarea class="form-control" name="detail" placeholder="Leave a comment here" id="floatingTextarea"><?= $pecah["detail"] ?></textarea>
                    </div>
                </div>
            </div>
            <div class="tombol ms-3 ps-5">
                <button class="ms-5 mb-4 btn btn-primary">
                    <a href="list.php" style="color: white;">
                        Kembali
                    </a>
                </button>
